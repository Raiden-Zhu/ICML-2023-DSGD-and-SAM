...
csgd64_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_CIFAR10s56-64-csgd-fixed-16-ResNet18_M-0-0.1-0.0-0.1-0.0-0-6000-6000-666-False.csv')
csgd512_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_CIFAR10s56-512-csgd-fixed-16-ResNet18_M-0-0.8-0.0-0.1-0.0-0-6000-6000-666-False.csv')
dsgd64_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_CIFAR10s56-64-ring-fixed-16-ResNet18_M-0-0.1-0.0-0.1-0.0-0-6000-6000-666-False.csv')
dsgd512_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_CIFAR10s56-512-ring-fixed-16-ResNet18_M-0-0.8-0.0-0.1-0.0-0-6000-6000-666-False.csv')
...
plt.show()
plt.savefig(f'figures/fig_cifar10_resnet18_wo_pretrain.pdf', format='pdf', bbox_inches='tight')
plt.close()
