...
csgd64_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-64-csgd-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-120-6000-6000-666-False.csv')
csgd512_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-512-csgd-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-120-6000-6000-666-False.csv')
dsgd64_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-64-ring-random-16-ResNet18_M-1-0.1-0.0-0.1-0.0-120-6000-6000-666-False.csv')
dsgd512_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-512-ring-random-16-ResNet18_M-1-0.8-0.0-0.1-0.0-120-6000-6000-666-False.csv')
...
plt.show()
plt.savefig(f'figures/fig_tinyimagenet_resnet18_ring.pdf', format='pdf', bbox_inches='tight')
plt.close()
...
csgd64_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-64-csgd-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-120-6000-6000-666-False.csv')
csgd512_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-512-csgd-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-120-6000-6000-666-False.csv')
dsgd64_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-64-exponential-random-16-ResNet18_M-1-0.1-0.0-0.1-0.0-120-6000-6000-666-False.csv')
dsgd512_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-512-exponential-random-16-ResNet18_M-1-0.8-0.0-0.1-0.0-120-6000-6000-666-False.csv')
...
plt.tick_params(labelsize=24)  #调整坐标轴数字大小
plt.show()
plt.savefig(f'figures/fig_tinyimagenet_resnet18_exponential.pdf', format='pdf', bbox_inches='tight')
plt.close()
...
csgd64_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-64-csgd-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-120-6000-6000-666-False.csv')
csgd512_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-512-csgd-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-120-6000-6000-666-False.csv')
dsgd64_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-64-meshgrid-random-16-ResNet18_M-1-0.1-0.0-0.1-0.0-120-6000-6000-666-False.csv')
dsgd512_seed666_path = os.path.join(ROOT, 'jupyter-chenkaixuan_TinyImageNets56-512-meshgrid-random-16-ResNet18_M-1-0.8-0.0-0.1-0.0-120-6000-6000-666-False.csv')
...
plt.tick_params(labelsize=24)  #调整坐标轴数字大小
plt.show()
plt.savefig(f'figures/fig_tinyimagenet_resnet18_grid.pdf', format='pdf', bbox_inches='tight')
plt.close()